...
_brm_total_scales_configured_2 = Base.merge(BayesianRegressionModels._brm_total_scales, quote
            tau ~ (BayesianRegressionModels.brm_vector_prior_b28d90387aac6d90)(3.0, 0.0, 2026.1; n = 1, lower = 0.0)
        end)
emitted @slic body:
begin
...
```julia
#= line 0 =# Turing.@model(function brm_model(y, callable_1, X_mu, random_effects_mu_1, callable_2, random_effects_mu_2, callable_3, callable_4, X_logsigma, random_effects_logsigma_1, callable_5)
        ...
        group_2_1 ~ DynamicPPL.to_submodel(BayesianRegressionModelsTuringExt._brm_group_effect_model(random_effects_logsigma_1, (callable_5(0.0, 2026.1, Distributions.TDist(3)),), nothing))
