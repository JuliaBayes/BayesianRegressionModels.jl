...
#   * Θ       Gaussian meas. error on the two continuous, binary variance Ŷ(1-Ŷ)
...
# at the occasion a Gaussian (2 continuous) + statistical-linearization (binary)
# update runs. 1.8378770664093453 = log(2pi) (a Julia const can't be @deffun'd).
