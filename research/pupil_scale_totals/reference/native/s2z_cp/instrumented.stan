...
parameters {
  ...
  vector[M_1 * (N_1 - 1)] z_s2z_1;  // physical orthonormal independent S2Z coordinates
  real<lower=0> udf_b_s2z_1;  // mixing variable for population coefficient 1
  vector<lower=0>[M_2] sd_2;  // group-level standard deviations
  vector[N_2 - 1] z_s2z_2;  // physical orthonormal scalar S2Z coordinates
...
transformed parameters {
  ...
  r_s2z_1_1 = sum_to_zero_constrain_brms(segment(z_s2z_1, (1 - 1) * (N_1 - 1) + 1, N_1 - 1));
  r_s2z_1_2 = sum_to_zero_constrain_brms(segment(z_s2z_1, (2 - 1) * (N_1 - 1) + 1, N_1 - 1));
  ...
  r_s2z_2_sigma_1 = sum_to_zero_constrain_brms(z_s2z_2);
