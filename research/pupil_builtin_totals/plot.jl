...
Label(figure[0,:],"Pupil: subject-specific means and numeric scale predictor";tellwidth=false,fontsize=24)
grid=sdraw!(figure[1,1],efficiency)
AlgebraOfGraphics.legend!(figure[1,2],grid)
Label(figure[2,:],"Efficiencies relative to brms NCP + native Stan · 46 scientific quantities · one chain per arm";tellwidth=false,fontsize=16)
...
println("PUPIL3_BUILTIN_PLOTS_COMPLETE")
