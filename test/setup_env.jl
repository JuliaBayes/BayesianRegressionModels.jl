...
const PINS = [
    ...
    ("StanBlocks",        "https://github.com/nsiccha/StanBlocks.jl.git",        "fe1d3b5eecb55e837659d1231d8078a7f39ca04c"),  # devibe (registers the native inv_cloglog builtin — StanBlocks snag stanblocks-trace-e1235cb1 / BRM snag brm-tracer-inv-c-a19794bc; contains 66448de, the prior-predictive fix, 9a958f97, the integer ragged carrier for in-cell discrete families over int ragged observations — snag ragged-int-obser-771dd259 — and bec23bc3, log_modified_bessel_first_kind for the periodic hsgp basis)
