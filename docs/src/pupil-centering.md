...
observed sampling and total efficiency**. All four
...
| brms CP | WHMC | 80,373 | 2.54× | 3.68× |
| brms S2Z CP | Native Stan | 319,693 | 135× | 40× |
| brms S2Z CP | WHMC | 188,667 | 137× | 66× |
| brms S2Z NCP | Native Stan | 771,035 | 1.17× | 1.22× |
| brms S2Z NCP | WHMC | 123,267 | 3.19× | 4.48× |
| brms S2Z auto | Native Stan | 150,012 | 187× | 62.6× |
| brms S2Z auto | WHMC | 64,875 | 173× | 194× |
| Totals CP | WHMC | 54,587 | 131× | 195× |
| Totals NCP | WHMC | 134,652 | 3.03× | 4.46× |
| Totals post-hoc position | WHMC | 168,932 | 258× | 71.2× |
| Totals post-hoc gradient | WHMC | 173,699 | 164× | 51.2× |
| Totals online position | WHMC | 35,586 | 164× | 217× |
| Totals online gradient | WHMC | 35,114 | 276× | 366× |

![The table plotted with logarithmic axes. Total gradient cost is better to the left; relative sampling and total efficiencies are better to the right. Orange denotes native Stan and blue WHMC. The baseline is ordinary brms NCP + native Stan; its two efficiencies equal 1. Points are single-chain pilot measurements, without uncertainty intervals.](assets/adaptive-pupil/efficiency.png)

Several distinctions matter:

- **Adaptation quality versus up-front cost:** post-hoc position ACP gives 258.3×
  the baseline's sampling efficiency, compared with total CP's 130.9×. But its NCP pilot
  costs 134,652 gradients and the refit 34,280, for 168,932 overall. Its total
  efficiency is consequently 71.2× the baseline, versus fixed CP's 194.8×.
...
- **Strong fixed and brms-auto controls remain useful:** total CP and
  brms S2Z auto + WHMC give 194.8× and 194.2× the baseline's total efficiency.
...
## 9. Inspect and reproduce the calculation

The saved source files can be inspected without rerunning the experiments.

- **Model, sampling and independent checks:** [manual total-coefficient target](https://github.com/nsiccha/BayesianRegressionModels.jl/blob/ns/devibe/research/pupil_total_effects/model.jl), [independent density/gradient audit](https://github.com/nsiccha/BayesianRegressionModels.jl/blob/ns/devibe/research/pupil_total_effects/audit.jl), [NCP pilot and post-hoc position refit](https://github.com/nsiccha/BayesianRegressionModels.jl/blob/ns/devibe/research/pupil_total_effects/run.jl), [fixed CP](https://github.com/nsiccha/BayesianRegressionModels.jl/blob/ns/devibe/research/pupil_total_effects/fixed_cp.jl).
- **Adaptation and recovery:** [online experiment](https://github.com/nsiccha/BayesianRegressionModels.jl/blob/ns/devibe/research/pupil_total_effects/online_transport_trial.jl), [post-hoc gradient selection](https://github.com/nsiccha/BayesianRegressionModels.jl/blob/ns/devibe/research/pupil_total_effects/offline_gradient_trial.jl), [conditional recovery](https://github.com/nsiccha/BayesianRegressionModels.jl/blob/ns/devibe/research/pupil_total_effects/recovery.jl), [46-QOI comparison for the added arms](https://github.com/nsiccha/BayesianRegressionModels.jl/blob/ns/devibe/research/pupil_total_effects/compare_online_trials.jl).
- **brms and native Stan harness:** [ordinary brms + WHMC](https://github.com/nsiccha/BayesianRegressionModels.jl/blob/ns/devibe/research/pupil_total_effects/brms_baseline.jl), [S2Z preparation/native sampling](https://github.com/nsiccha/BayesianRegressionModels.jl/blob/ns/devibe/research/pupil_total_effects/s2z_native.R), [S2Z + WHMC](https://github.com/nsiccha/BayesianRegressionModels.jl/blob/ns/devibe/research/pupil_total_effects/s2z_whmc.jl), [native gradient counter](https://github.com/nsiccha/BayesianRegressionModels.jl/blob/ns/devibe/research/pupil_total_effects/native_gradient_counter.hpp), [counter integration](https://github.com/nsiccha/BayesianRegressionModels.jl/blob/ns/devibe/research/pupil_total_effects/native_tools.R).
- **Exact generated Stan programs:** [ordinary NCP](https://github.com/nsiccha/BayesianRegressionModels.jl/blob/ns/devibe/research/pupil_total_effects/results/student_mixture/native_ncp/pupil-original.stan), [ordinary CP](https://github.com/nsiccha/BayesianRegressionModels.jl/blob/ns/devibe/research/pupil_total_effects/results/student_mixture/ordinary_cp/ordinary_cp.stan), [S2Z CP](https://github.com/nsiccha/BayesianRegressionModels.jl/blob/ns/devibe/research/pupil_total_effects/results/student_mixture/s2z_cp/clean.stan), [S2Z NCP](https://github.com/nsiccha/BayesianRegressionModels.jl/blob/ns/devibe/research/pupil_total_effects/results/student_mixture/s2z_ncp/clean.stan), [S2Z auto](https://github.com/nsiccha/BayesianRegressionModels.jl/blob/ns/devibe/research/pupil_total_effects/results/student_mixture/s2z_auto/clean.stan).
- **Numerical results:** [complete 15-row table](https://github.com/nsiccha/BayesianRegressionModels.jl/blob/ns/devibe/research/pupil_total_effects/results/online_adaptation/brief_matrix/qoi46.tsv), [original twelve arms, per QOI](https://github.com/nsiccha/BayesianRegressionModels.jl/blob/ns/devibe/research/pupil_total_effects/results/student_mixture/qoi46/parameters.tsv), [additional arms, per QOI](https://github.com/nsiccha/BayesianRegressionModels.jl/blob/ns/devibe/research/pupil_total_effects/results/online_adaptation/comparison/parameters.tsv), [online-fix and run manifest](https://github.com/nsiccha/BayesianRegressionModels.jl/blob/ns/devibe/research/pupil_total_effects/results/online_adaptation/receipt.json).
